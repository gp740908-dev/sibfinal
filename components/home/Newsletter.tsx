  ...
  return (
    <section className="relative py-24 px-6 md:px-12 bg-forest text-sand overflow-hidden border-t border-sand/10">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        <h2 className="text-4xl md:text-6xl font-serif mb-6 leading-tight text-sand">
          THE INNER <span className="italic text-accent-light">CIRCLE</span>
        </h2>

        <p className="font-sans text-lg text-sand/80 mb-10 max-w-xl mx-auto leading-relaxed font-light">
