      ...
      >
        <div className="px-6 md:px-12 grid grid-cols-3 items-center">
          ...
          >
            {/* 
              LOGO IMPLEMENTATION:
              - Icon: Uses /logosib.png
              - Text: HTML/CSS controlled for smooth collapse
              - Behavior: Full logo at top, Icon only on scroll
            */}
            <div className="flex items-center gap-3">
              <img 
                ...
                className={`h-auto w-auto transition-all duration-500 object-contain
                  ${isDarkState ? 'h-12 md:h-14' : 'h-16 md:h-20 brightness-0 invert'} 
                `}
              />
              
              {/* Text Container - Collapses on scroll */}
              <div 
                className={`flex flex-col justify-center overflow-hidden transition-all duration-500 ease-in-out origin-left
                  ${isScrolled ? 'max-w-0 opacity-0 scale-95' : 'max-w-[300px] opacity-100 scale-100'}
                `}
              >
                ...
                <span className={`font-sans text-[0.6rem] md:text-[0.7rem] uppercase tracking-[0.25em] leading-none mt-1 whitespace-nowrap ${textColor} opacity-90`}>
                  Villa Bali Culture
                </span>
              </div>
            </div>
            ...
            */}
            <div className="flex items-center gap-4 transition-all duration-500">
              <img 
                ...
                alt="StayinUBUD Icon" 
                className={`h-auto w-auto transition-all duration-500 object-contain
                  ${isDarkState ? 'h-14 md:h-16' : 'h-20 md:h-28 brightness-0 invert'} 
                `}
              />
              ...
              <div 
                ...
                `}
              >
                <span className={`font-serif text-3xl md:text-5xl leading-none tracking-tight whitespace-nowrap ${textColor}`}>
                  Stayin<span className="italic font-light">UBUD</span>
                </span>
                <span className={`font-sans text-[0.7rem] md:text-[0.8rem] uppercase tracking-[0.35em] leading-none mt-2 whitespace-nowrap ${textColor} opacity-90`}>
                  Villa Bali Culture
                </span>
              </div>
            </div>
