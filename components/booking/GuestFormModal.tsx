  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center px-4">
      ...
      <div className="relative bg-white w-full max-w-lg rounded-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        ...
        {/* Header with Summary */}
        <div className="bg-[#D3D49F]/20 p-6 border-b border-forest/10">
          <div className="flex justify-between items-start mb-4">
            <h3 className="font-serif text-2xl text-forest">Complete your Request</h3>
            <button onClick={onClose} className="text-forest/60 hover:text-forest transition-colors">
              <X size={24} />
            </button>
          </div>
          
          {/* Micro Summary */}
          <div className="flex justify-between items-center text-xs md:text-sm font-sans text-forest/80 bg-white/50 p-3 rounded-lg border border-forest/5">
            <div>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="space-y-1">
            <label className="text-[10px] uppercase tracking-widest text-forest/60 font-bold flex items-center gap-2">
            ...
            <input 
              ...
              className={`w-full border-b py-2 bg-transparent outline-none transition-all placeholder:text-gray-300 font-serif text-lg
                ${errors.fullName ? 'border-red-400' : 'border-gray-200 focus:border-forest'}
              `}
            />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-1">
              ...
              <input 
                ...
                className={`w-full border-b py-2 bg-transparent outline-none transition-all placeholder:text-gray-300 font-sans text-sm
                  ${errors.email ? 'border-red-400' : 'border-gray-200 focus:border-forest'}
                `}
              />
            ...
            <div className="space-y-1">
              ...
              <input 
                ...
                placeholder="+62 ..."
                className={`w-full border-b py-2 bg-transparent outline-none transition-all placeholder:text-gray-300 font-sans text-sm
                  ${errors.whatsapp ? 'border-red-400' : 'border-gray-200 focus:border-forest'}
                `}
              />
          ...
          <div className="space-y-1 pt-2">
            ...
            <textarea 
              ...
              rows={2}
              className="w-full border-b border-gray-200 focus:border-forest py-2 bg-transparent outline-none transition-all placeholder:text-gray-300 font-sans text-sm resize-none"
            />
          </div>
          ...
          <div className="pt-4">
            <button
              ...
              className="w-full bg-forest text-sand py-4 rounded-xl font-bold uppercase tracking-widest text-xs hover:bg-forest/90 shadow-lg hover:shadow-2xl hover:-translate-y-0.5 transition-all duration-300 flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed"
            >
              {isSubmitting ? (
                <>
