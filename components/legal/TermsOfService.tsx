  ...
  return (
    ...
    >
      <section id="agreement">
        <h2 className="text-2xl md:text-3xl font-serif text-forest-dark mb-6">1. Agreement to Terms</h2>
        <p>
      ...
      <section id="bookings">
        <h2 className="text-2xl md:text-3xl font-serif text-forest-dark mb-6">2. Bookings & Payments</h2>
        <p>
      ...
      <section id="cancellation">
        <h2 className="text-2xl md:text-3xl font-serif text-forest-dark mb-6">3. Cancellation Policy</h2>
      ...
      <section id="conduct">
        <h2 className="text-2xl md:text-3xl font-serif text-forest-dark mb-6">4. Guest Conduct</h2>
        <p>
      ...
      <section id="liability">
        <h2 className="text-2xl md:text-3xl font-serif text-forest-dark mb-6">5. Limitation of Liability</h2>
        <p>
      ...
      <section id="law">
        <h2 className="text-2xl md:text-3xl font-serif text-forest-dark mb-6">6. Governing Law</h2>
        <p>
