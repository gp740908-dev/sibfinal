    ...
    >
      ...
      <div className="relative w-full aspect-[4/5] overflow-hidden bg-forest/5">
        ...
        <div className="absolute top-4 left-4 z-20 opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-100">
          <span className="bg-sand/90 backdrop-blur text-forest-dark px-3 py-1 text-[10px] uppercase tracking-widest font-bold">
            View Details
          </span>
        </div>
      </div>
      ...
      <div className="flex flex-col items-center text-center px-4">
        {/* Title */}
        <h3 className="font-serif text-3xl text-forest-dark uppercase tracking-wide mb-2 group-hover:text-accent transition-colors duration-300">
          {villa.name}
        </h3>

        {/* Specs Row */}
        <div className="flex items-center gap-4 text-forest-dark/60 mb-4">
        ...
        <div className="flex flex-col items-center gap-1">
          <span className="font-serif text-xl text-forest-dark font-medium">
            {formatPrice(villa.pricePerNight)}
          </span>
          <span className="font-sans text-[10px] uppercase tracking-[0.2em] text-forest-dark/40">
            Per Night
          </span>
        </div>
      </div>
