...
export default function NewReviewPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const msg = handleSupabaseError(err, 'creating review');
            setError(msg);
    ...
    return (
        <div className="max-w-4xl mx-auto">
            <header className="mb-8">
                ...
                <h1 className="font-serif text-3xl md:text-4xl text-admin-forest">Add New Review</h1>
            </header>
            ...
            <form onSubmit={handleSubmit} className="glass-panel rounded-3xl p-8 space-y-6">
                ...
                <div className="flex justify-end gap-4 pt-6 border-t border-admin-forest/10">
                    ...
                    <button type="submit" disabled={saving} className="btn-primary">
                        {saving ? <><Loader2 size={16} className="animate-spin" /> Saving...</> : <><Save size={16} /> Create Review</>}
                    </button>
                </div>
